export const aboutText = {
    ru: {
        header: "О салоне",
        founder: "Цветана Курдова — вдохновитель и основатель салона красоты Opium, который стал для женщин местом душевного уюта. С 35-летним опытом в индустрии красоты и торговли, она и её команда дарят гармонию, заботу и уверенность в себе, создавая атмосферу, где каждая женщина чувствует себя уникальной.",
        section: {
            masters: {
                header: 'Мастера',
                elena: {
