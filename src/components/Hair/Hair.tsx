...
export default function Hair() {
    ...
    const services = aboutText[language].section.services.accordion_4.services;
    ...
    return (
        <div className={style.container}>
            <div className={style.about}>
                ...
                />
                <p className={style.description}>{aboutText[language].section.services.accordion_4.description}</p>
